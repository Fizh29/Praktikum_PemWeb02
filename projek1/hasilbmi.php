<?php require_once 'BMI_Class.php'; ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid">
        <div class="container d-flex justify-content-center py-5">
            <div class="col-md-12 col-12 p-3 rounded-3 bg-white shadow">
                ...
                $pasienbaru = new BMIpasien(count($listpasien)+1, $nama, $tmp_lahir,$tgl_lahir,$email,$kelamin,$tinggi,$berat);
                $pasienbaru->bmi = $pasienbaru->nilaibmi();
                array_push($listpasien, array($pasienbaru->id,$pasienbaru->tanggal,$pasienbaru->kode,$pasienbaru->nama,$pasienbaru->kelamin,$pasienbaru->berat,$pasienbaru->tinggi,$pasienbaru->bmi,$pasienbaru->statusbmi($pasienbaru->bmi)));
                echo "<h1 class='fw-bold text-center'>BMI Anda adalah <span class='text-primary'>{$pasienbaru->bmi}</span></h1>"; 
                if($pasienbaru->bmi <= 18.4){
                    echo "<h1 class='fw-bold text-center'><img src='assets/kurus.jpeg'></h1>";
                }
                elseif($pasienbaru->bmi >= 18.5 && $pasienbaru->bmi <= 23.9 ){
                    echo "<h1 class='fw-bold text-center'><img src='assets/sehat.jpeg'></h1>";
                }
                elseif ($pasienbaru->bmi  >= 24 && $pasienbaru->bmi  <= 26.9){
                    echo "<h1 class='fw-bold text-center'><img src='assets/gemuk.jpeg'></h1>";
                }
                elseif ($pasienbaru->bmi >= 27.0 && $pasienbaru->bmi <= 29.9){
                    echo "<h1 class='fw-bold text-center'><img src='assets/obe1.jpeg'></h1>";
                }
                elseif ($pasienbaru->bmi >= 30.0){
                    echo "<h1 class='fw-bold text-center'><img src='assets/obe2.jpeg'></h1>";
                }
